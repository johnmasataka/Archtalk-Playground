  ...
  return (
    ...
    <div className="chat-interface">
      <div className="controls-bar">
        <button className="control-button" onClick={toggleApiKeyModal}>Setting</button>
        {/* <button className="control-button">Setting</button> */}
          <button className="control-button" onClick={toggleHelpModal}>User Manual</button>
        ...
        <div className="api-key-modal">
          <div className="api-key-content">
            ...
            <div className="api-key-help">
              <a href="https://platform.openai.com/api-keys" className="api-key-link" target="_blank" rel="noopener noreferrer">How to get OpenAI API Key?</a>
            </div>
          </div>
        </div>
      )}
